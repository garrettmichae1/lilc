...
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strcpy");
    RequireCString(Parser, Param[1]->Val->Pointer, "strcpy");
...
void StringStrncpy(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strncpy");
    RequireCString(Parser, Param[1]->Val->Pointer, "strncpy");
...
void StringStrcmp(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strcmp");
    RequireCString(Parser, Param[1]->Val->Pointer, "strcmp");
...
void StringStrncmp(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strncmp");
    RequireCString(Parser, Param[1]->Val->Pointer, "strncmp");
...
void StringStrcat(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strcat");
    RequireCString(Parser, Param[1]->Val->Pointer, "strcat");
...
void StringStrncat(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strncat");
    RequireCString(Parser, Param[1]->Val->Pointer, "strncat");
...
void StringIndex(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "index");
...
void StringStrlen(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strlen");
...
void StringStrchr(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strchr");
...
void StringStrrchr(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strrchr");
...
void StringStrstr(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strstr");
    RequireCString(Parser, Param[1]->Val->Pointer, "strstr");
...
void StringStrdup(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    RequireCString(Parser, Param[0]->Val->Pointer, "strdup");
