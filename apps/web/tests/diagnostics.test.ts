...
hello.c:3:15 ';' expected`;
  ...
  it("maps a catalog of PicoC and runner messages", () => {
    const samples: Array<[string, string, string]> = [
      ...
      ["array 'grades' has no allocated storage", "ARRAY / MEMORY ERROR", "grades"],
      ["array has no allocated storage", "ARRAY / MEMORY ERROR", "allocated"],
      ["array size must be greater than 0", "ARRAY / MEMORY ERROR", "size"],
      ["array size is too large", "ARRAY / MEMORY ERROR", "size"],
